...
namespace GiyimMagazaOtomasyonu
{
    public partial class Yönetici : Form
    {
        ...
        public Yönetici()
        {
            ...
            comboBox5.DisplayMember = "PersonelId";
        ...
        private void button19_Click(object sender, EventArgs e)
        {
            ...
            if (textBox23.Text != "" || textBox21.Text != "" || textBox20.Text != "" || textBox19.Text != "")
                sonuc = fonk.UrunEkle(textBox23.Text,textBox21.Text,textBox20.Text,textBox19.Text,comboBox19.SelectedValue.ToString(),comboBox10.SelectedValue.ToString(), comboBox9.SelectedValue.ToString(), comboBox8.SelectedValue.ToString(), comboBox7.SelectedValue.ToString(), comboBox4.SelectedValue.ToString(), comboBox20.SelectedValue.ToString());
            if (sonuc == 1)
