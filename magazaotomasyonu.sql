...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 27 May 2017, 16:10:26
...
(2, 'Trabzon Sube', 1231231, 'adasdas', 'trabzon', 1),
(3, 'Ankara-Merke', 123123, '1241241241', 'Ankara', 1);
...
(3, 'furkan', 'bozkurt', 12345678, 'asdflnsadgasd', '2017-05-10', 12356, 1, 1, 1),
(4, 'personelAdi', 'personelSoyadi', 123456789, 'trabzon uzunsokak no:2', '2017-05-27', 1500, 1, 1, 2);
...
INSERT INTO `satis` (`SatisId`, `SatisAdedi`, `SatisTarihi`, `UrunId`, `MagazaId`, `PersonelId`) VALUES
(1, 1, '0000-00-00', 1, 1, 1),
(2, 1, '0000-00-00', 1, 1, 1),
(3, 1, '1995-10-10', 1, 1, 1),
(5, 2, '2017-05-08', 1, 1, 1),
(7, 1, '0000-00-00', 9, 1, 1);
...
--
ALTER TABLE `kategori`
  MODIFY `KategoriId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
-- Tablo için AUTO_INCREMENT değeri `kategoriad`
--
ALTER TABLE `kategoriad`
  MODIFY `KategoriAdId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `satis`
  MODIFY `SatisId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- Tablo için AUTO_INCREMENT değeri `stok`
--
ALTER TABLE `stok`
  MODIFY `StokId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
